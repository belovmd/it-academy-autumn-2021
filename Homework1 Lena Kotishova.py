...
print('Цена одной Вашей вещи составила {0} рубля {1} копеек, посчитать {2} предмета'.format(M, N, S))
total_rubles = M * S
total_kopeck = N * S
while total_kopeck >= 100:
    ...
    pass
print('Общая цена составит {} рублей {} копеек'.format(total_rubles, total_kopeck))  # last line of previous task
# next task docstring
